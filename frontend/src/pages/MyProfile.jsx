  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
    {
      ...
      <div className='mt-10'>
        {
          isEdit
          ? <button className='border border-indigo-500 px-8 py-2 rounded-full cursor-pointer hover:bg-indigo-500 hover:text-white transition-all' onClick={updateUserProfileData}>Save information</button>
          : <button className='border border-indigo-500 px-8 py-2 rounded-full cursor-pointer hover:bg-indigo-500 hover:text-white transition-all' onClick={()=>setIsEdit(true)}>Edit</button>
        }
      </div>
