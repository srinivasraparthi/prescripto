  ...
  return docInfo && (
    <div>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button onClick={bookAppointment} className='bg-indigo-500 text-white text-sm cursor-pointer font-light px-14 py-3 rounded-full my-6'>Book an appointment</button>
      </div>
