        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-500'>
            ...
            <div className='w-full lg:flex-1 flex flex-col gap-4'>
                ...
                <div className='flex-1 flex flex-col gap-1'>
                    ...
                    <input onChange={(e)=>setAddress2(e.target.value)} value={address2} className='border border-gray-300 rounded px-3 py-2' type="text" placeholder='Address 1' required />
                </div>
